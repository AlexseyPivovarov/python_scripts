...
class Square(Obj):
    ...
    def check_for_life(self):
        if not isinstance(LineAppBuilder.try_square(self.a, self.b, self.c, self.d), Square):
            raise Exception("Invalid arguments")
...
class Triangle(Obj):
    ...
    def check_for_life(self):
        ...
        elif LineAppBuilder.is_one_line(self.a, self.b, self.c):
