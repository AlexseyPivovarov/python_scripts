...
class SquareFactory:
    ...
    def try_square(mcs, a, b, c, d):
        ...
        for i in variants:  # counter of variants when point of line lie on straight other line
            if TriangleFactory.is_one_line(i[0], i[1], i[2]):
                result.append((TriangleFactory.longest_line(i[0], i[1], i[2]), i[3]))
...
class Square(Obj):
    ...
    def check_for_life(self):
        if not isinstance(SquareFactory.try_square(self.a, self.b, self.c, self.d), Square):
...
class Triangle(Obj):
    ...
    def check_for_life(self):
        ...
        elif TriangleFactory.is_one_line(self.a, self.b, self.c):
...
class Line(Obj):
    ...
    def __add__(self, other):
        if isinstance(other, Point):
            return TriangleFactory(self.a, self.b, other)
        elif isinstance(other, Line):
            return SquareFactory(self.a, self.b, other.a, other.b)
